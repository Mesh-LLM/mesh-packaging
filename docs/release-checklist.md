...
- If publishing to a dedicated Homebrew tap, confirm the tap PR/update is part of
  the release checklist and points at the GitHub Release tarballs and SHA256s
  generated by this workflow. The first production channel remains GitHub Release
  tarballs plus the rendered formula until that tap process exists.
